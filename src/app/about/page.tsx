          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-5xl mx-auto mt-12">
            {[
              ...
              <div key={idx} className="group relative">
                ...
                <div className="relative bg-linear-to-br from-bg-alt-dark to-bg-dark p-6 rounded-2xl border border-gold-primary/20 group-hover:border-gold-primary/40 transition-all duration-300">
      ...
      <Section dark>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Mission */}
            <div className="group relative bg-linear-to-br from-bg-alt-dark to-bg-dark rounded-3xl border border-gold-primary/20 hover:border-gold-primary/40 transition-all duration-500 overflow-hidden">
              ...
              <div className="relative z-10 p-8 sm:p-10">
                <div className="w-16 h-16 mb-6 bg-gold-primary/10 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="group relative bg-linear-to-br from-bg-alt-dark to-bg-dark rounded-3xl border border-gold-primary/20 hover:border-gold-primary/40 transition-all duration-500 overflow-hidden">
              ...
              <div className="relative z-10 p-8 sm:p-10">
                <div className="w-16 h-16 mb-6 bg-gold-secondary/10 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
      ...
      <Section dark>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            {[
              { name: "New Delhi", icon: "🏛️", desc: "Headquarters & Primary Office" },
              { name: "Gurgaon", icon: "🏢", desc: "Corporate Hub" },
              { name: "Noida", icon: "🏗️", desc: "Commercial Center" },
              { name: "Ghaziabad", icon: "🌆", desc: "Industrial Zone" },
              { name: "Greater NCR", icon: "📍", desc: "Extended Coverage" },
              { name: "Chandigarh", icon: "🏛️", desc: "Regional Office" },
              { name: "Jaipur", icon: "🕌", desc: "Rajasthan Hub" },
              { name: "Panipat", icon: "🏙️", desc: "Service Center" },
            ].map((city, idx) => (
              <div
                key={idx}
          ...
          <div className="mt-12 text-center">
            <div className="inline-block bg-linear-to-br from-gold-primary/10 to-transparent p-8 rounded-2xl border border-gold-primary/30">
